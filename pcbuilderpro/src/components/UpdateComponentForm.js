...
function UpdateComponentForm() {
    ...
    return (
        ...
        <div>
        <div>
            <h2 className="bg-dark text-light p-3 text-center">Update Component Form</h2>
            <br></br>
            <div className="container m-auto w-25">
                <form action="" onSubmit={handleSubmit} >
                <div class="mb-3 mt-3 center">
                        {/* <label for="name" class="form-label">Name:  </label> */}
                        <input className="form-control" type="hidden" name="id" placeholder="compId" value={inputs.id} onChange={handleChange} />
                    </div>
                    <div class="mb-3 mt-3 center">
                        {/* <label for="name" class="form-label">Name:  </label> */}
